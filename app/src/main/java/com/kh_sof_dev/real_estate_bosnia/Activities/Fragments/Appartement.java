...
public class Appartement extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MainActivity.mLisstenner_Appart=new MainActivity.onsleactGoverment() {
            @Override
...
//                Toast.makeText(getContext(),items_.size()+"   size  ",Toast.LENGTH_SHORT).show();

                for (MainActivity.items i:items_
                ) {
//                    Toast.makeText(getContext(),i.name+"   name  ",Toast.LENGTH_SHORT).show();

                    real_estateList_filter.clear();
                    switch (i.name){
                        case "r":
                            real_estateList_filter.addAll(filter(i.value1,i.value2,"room",real_estateList_filter));
                            break;
                        case "ba":
                            real_estateList_filter.addAll(filter(i.value1,i.value2,"bath",real_estateList_filter));
                            break;
                        case "b":
                            real_estateList_filter.addAll(filter(i.value1,i.value2,"bulding",real_estateList_filter));
                            break;
                        case "p":
    ...
    private void GetAllMun(final String gov){
        ...
        mRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                for (DataSnapshot dts: dataSnapshot.child("Apartment").getChildren()
                ) {
